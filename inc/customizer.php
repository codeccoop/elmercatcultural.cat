...
function customize_preview_js() {
	wp_enqueue_script( 'elmercatcultural.cat-customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), ELMERCATCULTURAL.CAT_VERSION, true );
}
