...
function woocommerce_scripts() {
	wp_enqueue_style( 'elmercatcultural.cat-woocommerce-style', get_template_directory_uri() . '/woocommerce.css', array(), ELMERCATCULTURAL.CAT_VERSION );
...
if ( ! function_exists( 'woocommerce_cart_link' ) ) {
	...
	function woocommerce_cart_link() {
		?>
		<a class="cart-contents" href="<?php echo esc_url( wc_get_cart_url() ); ?>" title="<?php esc_attr_e( 'View your shopping cart', 'elmercatcultural.cat' ); ?>">
			<?php
			$item_count_text = sprintf(
				/* translators: number of items in the mini cart. */
				_n( '%d item', '%d items', WC()->cart->get_cart_contents_count(), 'elmercatcultural.cat' ),
